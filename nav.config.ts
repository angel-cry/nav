...
const c: IConfig = {
  // [必填], 请填写您的仓库地址
  gitRepoUrl: 'https://github.com/angel-cry/nav',
  ...
  // 您的网站地址，有利于SEO
  homeUrl: 'https://lazyif.com',

  // 网站标题
  title: '懒人导航 - 给懒人用的导航网站',

  // 网站描述
  description: '懒人导航 - 没事就来逛逛总有你要的',

  // 网站关键字
  keywords: '导航,黑科技,非常规,灰色,实用工具,学习资源,运营,网络安全,node.js',
  ...
  footerContent: `
    ...
    <div>Copyright © 2018-2021 lazyif.com, All Rights Reserved</div>
  `,
